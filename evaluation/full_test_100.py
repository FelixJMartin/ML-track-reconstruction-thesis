...
from train_s1_100 import ConeFilterSNN
from train_s2_100 import PhiFinderSNN
...
plt.rcParams.update({
    ...
    # --- add these ---
    "legend.frameon": True,
    "legend.edgecolor": "#888888",   # softer grey border
    "legend.facecolor": "white",
    "legend.framealpha": 0.85,       # slightly see-through
})
...
legend.get_frame().set_linewidth(0.6)  # slimmer border
