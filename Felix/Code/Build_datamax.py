...
if __name__ == "__main__":
    ...
    for noise in NOISE_LEVELS:
        ...
        save_dir  = os.path.join(base_save, f"matrices_{BINS}_{noise_pct}pct")
        ...
        if os.path.exists(os.path.join(save_dir, "X_rz.npy")):
            print("  Already exists — skipping. Delete folder to rebuild.")
            ...
            build_dataset(data_dir, event_ids, save_dir, noise, BINS)
