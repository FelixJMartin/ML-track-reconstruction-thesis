...
from build_data100 import (make_rz_grid, get_cone, CONE_SIGNS,
...
test_ids  = [f"event{i:09d}" for i in range(1080, 1100)]  # last 20 of the 100

# note: these events were part of the 100-event training set (1000-1099)
# this ROC is a development diagnostic, not a held-out evaluation
# the held-out ROC is in ROC_1000.py using train_1 events 2800-2820
