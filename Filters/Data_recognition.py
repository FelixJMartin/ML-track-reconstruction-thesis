...
# All pairwise plots of hit coordinates colored by volume
vars_ = ["x", "y", "z"]

sns.pairplot(
    hits[vars_ + ["volume_id"]],
    vars=vars_,
    hue="volume_id",
    corner=True,        #
    height=3
...
# Plottning distributions of number of hits per particle and particle charges
