...
The SPArch RadLIF implementation is included directly in `Felix/SNN/snns.py`, adapted from [Bittar & Garner (2022)](https://doi.org/10.3389/fnins.2022.865897).
...
For cluster (UPPMAX/SLURM) runs, see the submission scripts in `Felix/Code/submit_*.sh`.
